...
import { updateProjectSchema } from "../form-schemas";
...
const EditProjectForm = ({ initialValues, onCancel }: EditProjectFormProps) => {
    ...
    const finalValues = {
      ...
      image:
        ...
        (typeof values.image === "string" &&
          values.image.startsWith("data:image/png;base64,"))
          ? values.image
          : "",
    };
